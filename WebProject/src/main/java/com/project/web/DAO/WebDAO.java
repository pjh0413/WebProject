...
public void signUp(final String userId, final String userPwd, final String userName, final String userGender, final String userAddr1, final String userAddr2, final String userPhone, final String userEmail, final Timestamp regDate){
		...
		template.update(new PreparedStatementCreator() {
			...
			public PreparedStatement createPreparedStatement(Connection conn) throws SQLException {
				String query = "insert into member_table (userNo, userId, userPwd, userName, userGender, userAddr1, userAddr2, userPhone, userEmail, regDate) "
	...
	public ArrayList<WebVO> memberList(){
		String query = "select userNo, userId, userName, userAddr1, userAddr2, userPhone, userEmail, regdate from member_table order by userNo asc";
